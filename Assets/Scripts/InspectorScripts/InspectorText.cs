...
namespace Inspector
{
    public class InspectorText : InspectorItem
    {
        ...
        public override void Init(Transform contentArea,GameObject _selectObj)
        {
            ...
            GameObject tempTextName = GameObject.Instantiate(inspectorPanel.oneValue, contentArea);
            ...
            GameObject tempTextPos = GameObject.Instantiate(inspectorPanel.twoValue, contentArea);
